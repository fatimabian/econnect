...
<title>ECOnnect Barangay Admin</title>
...
<div class="sidebar collapsed" id="sidebarMenu">
    ...
    <div class="nav-item <?= ($currentPage == 'collection_management.php') ? 'active' : '' ?>" onclick="location.href='collection_management.php'">
        ...
        <span class="nav-text">Collection Schedule</span>
    </div>
...
function saveSidebarState() {
    ...
    localStorage.setItem('barangaySidebarCollapsed', isCollapsed);
}

function loadSidebarState() {
    const savedState = localStorage.getItem('barangaySidebarCollapsed');
    if (savedState === 'true') {
